...
// CHECK-SAME:  %[[ARG1:.*]]: tensor<4x16x32x16xf32>) -> tensor<128x256xf32> {
// CHECK: %[[PACKED:.*]] = tensor.pack %[[ARG0]] inner_dims_pos = [0, 1] inner_tiles = [32, 16] into %[[ARG1]] : tensor<128x256xf32> -> tensor<4x16x32x16xf32>
// CHECK: %[[BUFF:.*]] = tensor.empty() : tensor<128x256xf32>
// CHECK: %[[UNPACKED:.*]] = tensor.unpack %[[PACKED]] inner_dims_pos = [0, 1] inner_tiles = [32, 16] into %[[BUFF]] : tensor<4x16x32x16xf32> -> tensor<128x256xf32>
